...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class MapsLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>mobile</b> with <b>com.yandex.android:maps.mobile</b> coordinates and
         * with version reference <b>mapsMobile</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getMobile() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("maps.mobile");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>mapsMobile</b> with value <b>4.7.0-full</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMapsMobile() { return getVersion("mapsMobile"); }
    ...
    public static class DaggerHiltPluginAccessors extends PluginFactory {
        private final DaggerHiltAndroiPluginAccessors paccForDaggerHiltAndroiPluginAccessors = new DaggerHiltAndroiPluginAccessors(providers, config);

        public DaggerHiltPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of plugins at <b>plugins.dagger.hilt.androi</b>
         */
        public DaggerHiltAndroiPluginAccessors getAndroi() {
            return paccForDaggerHiltAndroiPluginAccessors;
        }

    }

    public static class DaggerHiltAndroiPluginAccessors extends PluginFactory {

        public DaggerHiltAndroiPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>dagger.hilt.androi.plugin</b> with plugin id <b>dagger.hilt.android.plugin</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getPlugin() { return createPlugin("dagger.hilt.androi.plugin"); }
